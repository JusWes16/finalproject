    ...
    <div id="content">
        ...
        <main id="add-class">
            ...
            <form action="/phpmotors/vehicles/index.php" method="post">
                <label for="carClassification">Classification<sup>*</sup></label>
                <input type="text" name="carClassification" id="carClassification" required>
                
                <input type="submit" name="submit" id="new-class" value="Add Classification">
